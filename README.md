# chemistry-quiz-1
An interactive chemistry quiz covering **organic chemistry**, **chemical kinetics**, and **analytical chemistry** built with **HTML only**
## 🧪 Overview
...
- **Single HTML File**: Everything in one file — no external dependencies
...
- **Interactive Elements**: HTML `<form>`, `<input type="radio">`, `<label>`
- **Styling**: Inline CSS only (no external stylesheet)
- **No JavaScript**: All interactivity through HTML form elements and CSS hover effects
- **Browser Compatibility**: Works in all modern browsers

## 💡 HTML-Only Interactivity

This quiz uses clever HTML/CSS techniques for interactivity without JavaScript:
- Radio buttons for answer selection
- HTML form submission for answer checking
- CSS `:checked` pseudo-class for visual feedback
- HTML `required` attribute for validation
...
- Chemistry students (AP Chemistry, undergraduate, graduate)
- Organic chemistry review
- Kinetics practice problems
- Analytical chemistry exam preparation
